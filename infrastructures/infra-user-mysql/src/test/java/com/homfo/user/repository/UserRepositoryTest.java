...
public class UserRepositoryTest {
    ...
    void findByAccount_ReturnsUser() {
        ...
        // when
        Optional<MySqlUser> foundUser = userRepository.findByAccount(user.getAccount());
    ...
    void findByAccountOrNicknameOrPhoneNumber_ReturnsUser() {
        ...
        // when
        Optional<MySqlUser> foundUser = userRepository.findByAccountOrNicknameOrPhoneNumber(user.getAccount(), user.getNickname(), user.getPhoneNumber());
    ...
    void findByIdAndStatusNot_ReturnsUser() {
        ...
        // when
        Optional<MySqlUser> foundUser = userRepository.findByIdAndStatusNot(user.getId(), UserStatus.DELETED);
